...
<html lang="en">
    ...
    <head>
        ...
        <title>Livros em Movimento</title>
    ...
    <body>
        ...
        <section id="welcome">
            <div class="container">
                ...
                <img class="img-responsive center-block" src="img/portfolio/user.png" alt="logo">
            </div>
        </section>
        ...
        <section id="services">
            <div class="container">
                ...
                <div class="services-box">
                            ...
                            <table>
                                <tr>
                                    <td style="padding-right: 20px; padding-left: 50px;">   
                                        <img src="img/estante/fotr.jpg" alt="fotr">
                                    </td>
                                    <td class="media-body">
                    ...
                    <div class="row wow fadeInUp" data-wow-delay=".6s" style="padding-bottom: 40px;">
                        <div class="col-md-4">
                            <table>
                                <tr>
                                    <td style="padding-right: 20px; padding-left: 50px;"> 
